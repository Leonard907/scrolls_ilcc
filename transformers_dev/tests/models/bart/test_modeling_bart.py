...
from transformersDev import BartConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev.models.bart.modeling_bart import BartDecoder, BartEncoder, shift_tokens_right
