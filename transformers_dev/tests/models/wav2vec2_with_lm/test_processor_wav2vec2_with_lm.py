...
from transformersDev import AutoProcessor
from transformersDev.models.wav2vec2 import Wav2Vec2CTCTokenizer, Wav2Vec2FeatureExtractor
from transformersDev.models.wav2vec2.tokenization_wav2vec2 import VOCAB_FILES_NAMES
from transformersDev.testing_utils import require_pyctcdecode, require_torch, require_torchaudio, slow
from transformersDev.utils import FEATURE_EXTRACTOR_NAME, is_pyctcdecode_available, is_torch_available
...
if is_pyctcdecode_available():
    ...
    from transformersDev.models.wav2vec2_with_lm import Wav2Vec2ProcessorWithLM
    from transformersDev.models.wav2vec2_with_lm.processing_wav2vec2_with_lm import Wav2Vec2DecoderWithLMOutput

if is_torch_available():
    from transformersDev import Wav2Vec2ForCTC
