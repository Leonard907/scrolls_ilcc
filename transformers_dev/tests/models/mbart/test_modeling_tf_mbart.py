...
from transformersDev import AutoTokenizer, MBartConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformersDev import TFAutoModelForSeq2SeqLM, TFMBartForConditionalGeneration, TFMBartModel
