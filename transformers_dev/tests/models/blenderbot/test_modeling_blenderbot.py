...
from transformersDev import BlenderbotConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev import BlenderbotForConditionalGeneration, BlenderbotModel, BlenderbotTokenizer
    from transformersDev.models.blenderbot.modeling_blenderbot import (
        BlenderbotDecoder,
        BlenderbotEncoder,
