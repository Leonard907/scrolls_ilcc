...
from transformersDev import AutoTokenizer, PegasusConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformersDev import TFAutoModelForSeq2SeqLM, TFPegasusForConditionalGeneration, TFPegasusModel
