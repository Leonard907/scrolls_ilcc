...
from transformersDev import BlenderbotSmallConfig, BlenderbotSmallTokenizer, is_tf_available
from transformersDev.testing_utils import require_tf, require_tokenizers, slow
...
if is_tf_available():
    ...
    from transformersDev import TFAutoModelForSeq2SeqLM, TFBlenderbotSmallForConditionalGeneration, TFBlenderbotSmallModel
