...
from transformersDev import T5Config, is_tf_available
...
if is_tf_available():
    ...
    from transformersDev import ByT5Tokenizer, T5Tokenizer, TFT5EncoderModel, TFT5ForConditionalGeneration, TFT5Model
