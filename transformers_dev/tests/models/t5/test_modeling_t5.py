...
from transformersDev import T5Config, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev import ByT5Tokenizer, T5EncoderModel, T5ForConditionalGeneration, T5Model, T5Tokenizer
