...
from transformersDev import LxmertConfig, is_tf_available, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev.models.lxmert.modeling_lxmert import LXMERT_PRETRAINED_MODEL_ARCHIVE_LIST
