...
from transformersDev import LxmertConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformersDev.models.lxmert.modeling_tf_lxmert import TFLxmertForPreTraining, TFLxmertModel
