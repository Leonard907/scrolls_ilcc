...
from transformersDev import GPT2Config, GPT2Tokenizer, is_flax_available, is_torch_available
...
if is_flax_available():
    ...
    from transformersDev.models.gpt2.modeling_flax_gpt2 import FlaxGPT2LMHeadModel, FlaxGPT2Model
