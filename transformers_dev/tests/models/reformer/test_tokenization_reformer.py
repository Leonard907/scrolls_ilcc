...
from transformersDev import SPIECE_UNDERLINE, ReformerTokenizer, ReformerTokenizerFast
from transformersDev.testing_utils import get_tests_dir, require_sentencepiece, require_tokenizers, require_torch, slow
...
class ReformerTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_torch_encode_plus_sent_to_model(self):
        ...
        from transformersDev import ReformerConfig, ReformerModel
