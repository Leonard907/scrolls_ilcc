...
from transformersDev import DPTConfig
...
if is_torch_available():
    ...
    from transformersDev import MODEL_MAPPING, DPTForDepthEstimation, DPTForSemanticSegmentation, DPTModel
    from transformersDev.models.dpt.modeling_dpt import DPT_PRETRAINED_MODEL_ARCHIVE_LIST
