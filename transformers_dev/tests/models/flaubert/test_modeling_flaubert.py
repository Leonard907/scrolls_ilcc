...
from transformersDev import FlaubertConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev.models.flaubert.modeling_flaubert import FLAUBERT_PRETRAINED_MODEL_ARCHIVE_LIST
