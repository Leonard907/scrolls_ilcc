...
from transformersDev import Speech2TextTokenizer, is_speech_available
from transformersDev.models.speech_to_text.tokenization_speech_to_text import VOCAB_FILES_NAMES, save_json
from transformersDev.testing_utils import get_tests_dir, require_sentencepiece, require_torch, require_torchaudio
from transformersDev.utils import FEATURE_EXTRACTOR_NAME

from .test_feature_extraction_speech_to_text import floats_list


if is_speech_available():
    from transformersDev import Speech2TextFeatureExtractor, Speech2TextProcessor
