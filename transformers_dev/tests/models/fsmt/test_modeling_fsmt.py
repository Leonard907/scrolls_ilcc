...
from transformersDev import FSMTConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev import FSMTForConditionalGeneration, FSMTModel, FSMTTokenizer
    from transformersDev.models.fsmt.modeling_fsmt import (
        SinusoidalPositionalEmbedding,
        _prepare_fsmt_decoder_inputs,
        invert_mask,
        shift_tokens_right,
    )
    from transformersDev.pipelines import TranslationPipeline
