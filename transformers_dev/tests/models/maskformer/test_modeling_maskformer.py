...
from transformersDev import DetrConfig, MaskFormerConfig, SwinConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from transformersDev import MaskFormerForInstanceSegmentation, MaskFormerModel
