...
from transformersDev import ElectraConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformersDev.models.electra.modeling_electra import ELECTRA_PRETRAINED_MODEL_ARCHIVE_LIST
