...
from transformersDev import GPT2Tokenizer, GPTNeoConfig, is_flax_available, is_torch_available
...
if is_flax_available():
    ...
    from transformersDev.models.gpt_neo.modeling_flax_gpt_neo import FlaxGPTNeoForCausalLM, FlaxGPTNeoModel
