...
from transformersDev import AlbertConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformersDev import TF_MODEL_FOR_PRETRAINING_MAPPING
    from transformersDev.models.albert.modeling_tf_albert import (
