...
from transformersDev import SPIECE_UNDERLINE, BatchEncoding, PLBartTokenizer, is_torch_available
...
if is_torch_available():
    from transformersDev.models.plbart.modeling_plbart import shift_tokens_right
