...
from transformersDev import ViTConfig, is_flax_available
...
if is_flax_available():
    ...
    import jax
    from transformersDev.models.vit.modeling_flax_vit import FlaxViTForImageClassification, FlaxViTModel
