...
from transformersDev.utils import is_tf_available, is_vision_available
...
if is_tf_available():
    ...
    from transformersDev import TFCLIPModel, TFCLIPTextModel, TFCLIPVisionModel, TFSharedEmbeddings
    from transformersDev.models.clip.modeling_tf_clip import TF_CLIP_PRETRAINED_MODEL_ARCHIVE_LIST
