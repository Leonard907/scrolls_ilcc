...
from transformersDev import PerceiverConfig
from transformersDev.models.auto import get_values
from transformersDev.testing_utils import require_torch, require_torch_multi_gpu, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from transformersDev.models.perceiver.modeling_perceiver import PERCEIVER_PRETRAINED_MODEL_ARCHIVE_LIST


if is_vision_available():
    from PIL import Image

    from transformersDev import PerceiverFeatureExtractor
