...
from transformersDev import BigBirdConfig, FlaxBigBirdForQuestionAnswering
from transformersDev.models.big_bird.modeling_flax_big_bird import FlaxBigBirdForQuestionAnsweringModule
