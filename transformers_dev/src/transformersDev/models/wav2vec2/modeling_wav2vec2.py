...
# Copied from transformersDev.models.bart.modeling_bart.BartAttention with Bart->Wav2Vec2
...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformersDev import AutoFeatureExtractor, Wav2Vec2ForPreTraining
