...
# Copied from transformersDev.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from transformersDev.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformersDev import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
    ...
    ```python
    >>> from transformersDev import MBartTokenizer, TFMBartForConditionalGeneration
