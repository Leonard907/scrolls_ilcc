...
# Copied from transformersDev.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->OPT
...
# Copied from transformersDev.models.bart.modeling_flax_bart.FlaxBartModel with Bart->OPT
