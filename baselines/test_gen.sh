...
python scripts/execute.py scripts/commands/generate.py gov_report_longt5-local_validation --checkpoint_path outputs/google-long-t5-tglobal-base_8192_32_0.001_8192_scrolls_gov_report_language-truck-416
