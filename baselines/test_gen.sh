...
python scripts/execute.py scripts/commands/generate.py gov_report_longt5-local_validation --checkpoint_path outputs/saved_models/longt5_8192_inner_product_epoch_7_mem_32K
